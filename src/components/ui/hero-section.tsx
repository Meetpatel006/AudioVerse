                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">No Credit Card Required</span>
                                    ...
                                    <h1
                                        ...
                                        Elevate Your Content with AI Voices
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                                        Instantly generate lifelike speech, voiceovers, and sound effects. Free tier available for all creators, developers, and businesses—start creating audio magic today!
                                    </p>
                                </AnimatedGroup>
                                <AnimatedGroup
                                    variants={{
