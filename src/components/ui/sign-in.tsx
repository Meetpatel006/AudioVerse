...
const TestimonialCard = ({ testimonial, delay }: { testimonial: Testimonial, delay: string }) => (
  <div className={`animate-testimonial ${delay} flex items-start gap-3 rounded-3xl bg-card/40 backdrop-blur-xl border border-gray-200/50 p-5 w-64 shadow-sm`}>
    <Image 
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full flex items-center justify-center gap-2 ${isLoading ? 'bg-violet-400' : 'bg-violet-500 hover:bg-violet-600'} text-white py-4 px-6 rounded-2xl font-medium transition-colors duration-200 shadow-lg shadow-violet-500/20 hover:shadow-violet-500/30 disabled:opacity-70 disabled:cursor-not-allowed`}
              >
                {isLoading ? (
                  <>
